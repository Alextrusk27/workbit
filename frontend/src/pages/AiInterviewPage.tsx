...
const steps = [
  {
    ...
    body: 'Укажите профессию и уровень — или вставьте ссылку на вакансию с hh.ru, и вопросы соберутся под требования работодателя.',
  },
  {
    n: '2',
  ...
  },
  {
    ...
    body: 'Балл за каждый ответ, правки на полях и итоговая вероятность оффера — как если бы решение принимал интервьюер.',
  },
]
...
export function AiInterviewPage() {
  ...
  return (
    <>
      ...
      >
        Полная сессия из вопросов под вашу роль или конкретную вакансию.
        Отвечаете текстом или голосом, в конце — вердикт и вероятность оффера.
      </PageHero>
        ...
        <Container>
          <Reveal>
            <SectionHead title="Три шага до вердикта">
              Никаких тестов с вариантами — живой диалог, как с настоящим
              интервьюером.
            </SectionHead>
          </Reveal>
      ...
      <section className="pb-22">
        <Container>
          <Reveal>
            ...
            >
              Три сессии в месяц на бесплатном тарифе. Карта не нужна.
            </CtaPanel>
          </Reveal>
        </Container>
      </section>
