...
const features = [
  {
    ...
    body: 'Профессия, уровень и тип компании — вопросы подстраиваются под то, к чему вы готовитесь. Любая роль, не только IT.',
  },
  {
    icon: <IconLink />,
  ...
  },
  {
    ...
    body: 'Итоговый фидбэк по сессии и честная оценка шансов — как если бы решение принимал интервьюер.',
  },
  {
    icon: <IconClock />,
          ...
          <Reveal className="mx-auto max-w-200">
            ...
            <div className="border-line bg-card rounded-2xl border p-7">
              ...
              >
                ...
                <p className="text-dim text-[13.5px]">
                  Отвечаете текстом, своими словами. Тренажёр ждёт столько,
                  сколько нужно.
                </p>
              </div>
