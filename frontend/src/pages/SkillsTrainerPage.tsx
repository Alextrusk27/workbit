...
const advantages = [
  ...
  'История тренировок хранит оценки — видно, что уже проходили и с каким результатом',
]
...
const audience = [
  ...
  },
  {
    ...
    body: 'Десять вопросов за подход — удобно тренироваться каждый день, а не раз в неделю по три часа. Мало — возьмите ещё пачку.',
  },
  {
    icon: <IconChart />,
    title: 'История тренировок',
    body: 'Все тренировки сохраняются с оценками — видно, какой навык уже брали и с каким результатом.',
  },
]
          ...
          <Reveal>
            <div className="grid items-center gap-16 lg:grid-cols-[minmax(0,6fr)_minmax(0,5fr)]">
              ...
              <ChatShell
                ...
                status="вопрос 4 из 10"
              >
                <ChatBubble role="bot" who="Вопрос 4 / 10">
        ...
        <Container>
          <Reveal>
            <SectionHead title="Для любой профессии">
              Тренажёр собирает вопросы под любую роль из справочника или вашу
              собственную.
            </SectionHead>
          </Reveal>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
