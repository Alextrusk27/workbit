...
class TrainingQuestionMapperTest {
    ...
    private final TrainingQuestionMapper mapper = new TrainingQuestionMapperImpl();

    private TrainingQuestion.TrainingQuestionBuilder aQuestion() {
    ...
    class ToDto {
        ...
        @Test
        @DisplayName("Переносит все поля вопроса, включая score/feedback из TrainingFeedback")
        void mapsAllFieldsWithFeedback() {
            // given
            var feedback = TrainingFeedback.builder()
                    .score(4)
            ...
            // when
            TrainingQuestionResponse dto = mapper.toDto(question);
        ...
        @Test
        @DisplayName("score и feedback остаются null, когда у вопроса нет TrainingFeedback")
